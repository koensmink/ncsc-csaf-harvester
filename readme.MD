...
Ondersteunt *dagelijkse harvesting*, *severity-filtering* en real-time **Telegram-meldingen** voor relevante risico’s.
...
### ✔ Harvester (CSAF + HTML)
`harvest_ncsc.py` haalt advisories op via de officiële CSAF-feed en een HTML-fallback.
